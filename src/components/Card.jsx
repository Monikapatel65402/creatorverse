...
const PLACEHOLDER = 'https://placehold.co/600x400/0d1626/00b4d8?text=No+Image'
...
function PlatformIcon({ url }) {
  ...
  if (url.includes('twitch.tv'))
    return (
      <svg viewBox="0 0 24 24" width="18" height="18" fill="#9146FF">
  ...
  if (url.includes('instagram.com'))
    return (
      <svg viewBox="0 0 24 24" width="18" height="18" fill="#E1306C">
  ...
  return (
    ...
    >
      ...
      <div className="card-top">
        <Link to={`/creator/${slug}`} className="card-icon-btn" title="View">
        ...
        <Link to={`/creator/${slug}/edit`} className="card-icon-btn" title="Edit">
      ...
      <div className="card-bottom">
        <h3 className="card-name">
          <Link to={`/creator/${slug}`}>{name}</Link>
        </h3>
